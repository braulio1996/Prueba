...
a persistence unit "AplacacionesBancoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "AplacacionesBanco\pom.xml":
...
artifact ("AplacacionesBanco.war") is already built. You can build
