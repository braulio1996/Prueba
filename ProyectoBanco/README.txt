...
a persistence unit "ProyectoBancoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ProyectoBanco\pom.xml":
...
artifact ("ProyectoBanco.war") is already built. You can build
