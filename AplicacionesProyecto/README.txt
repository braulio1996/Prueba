...
a persistence unit "ApliacionesProyectoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ApliacionesProyecto\pom.xml":
...
artifact ("ApliacionesProyecto.war") is already built. You can build
