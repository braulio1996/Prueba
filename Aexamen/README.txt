...
a persistence unit "ContatoswebPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Contatosweb\pom.xml":
...
artifact ("Contatosweb.war") is already built. You can build
